...
// AtlasTextObjectContents and Atlases.ITEMS/BLOCKS not available in 1.21.8; using Text.empty() fallback
...
public class ArcanaUtils {
   ...
   public static MutableText getAtlasedTexture(Item item){
      // AtlasTextObjectContents not available in 1.21.8; return empty text as fallback
      return Text.empty();
   }
