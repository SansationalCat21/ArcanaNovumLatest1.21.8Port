...
public class ArcanaRegistry {
   ...
   public static final ChunkTicketType ANCHOR_TICKET_TYPE = registerTicketType("arcananovum_anchor", 40L);
   ...
   private static ChunkTicketType registerTicketType(String id, long expiryTicks) {
      // 1.21.8: Use ChunkTicketType.FORCED.use() to get the load+simulate Use value without guessing the enum constant name
      return Registry.register(Registries.TICKET_TYPE, id, new ChunkTicketType(expiryTicks, true, ChunkTicketType.FORCED.use()));
   }
