...
public class StasisPearlEntity extends EnderPearlEntity implements PolymerEntity {
   ...
   public void resyncHolder(){
      ServerPlayerEntity holder = ArcanaItemUtils.findHolder(this.getWorld().getServer(),itemStackId);
   ...
   protected void onCollision(HitResult hitResult){
      ...
      if(itemStackId != null && getWorld().getServer() != null){
         holder = ArcanaItemUtils.findHolder(getWorld().getServer(),itemStackId);
