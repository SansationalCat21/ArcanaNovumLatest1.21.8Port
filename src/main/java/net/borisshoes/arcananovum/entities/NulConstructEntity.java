...
public class NulConstructEntity extends HostileEntity implements PolymerEntity, RangedAttackMob {
   ...
   public void onSummoned(PlayerEntity summoner, boolean mythic){
      ...
      NulConstructDialog.announce(summoner.getWorld().getServer(),summoner,this, Announcements.SUMMON_TEXT);
      NulConstructEntity construct = this;
      BorisLib.addTickTimerCallback(serverWorld, new GenericTimer(this.getInvulnerableTimer(), () -> {
         NulConstructDialog.announce(summoner.getWorld().getServer(),summoner,construct, Announcements.SUMMON_DIALOG, new boolean[]{summonerHasDivine,summonerHasWings,!summonerHasWings, false, true, isExalted, !isExalted});
   ...
   public void deconstruct(){
      if(summoner != null){
         NulConstructDialog.announce(getWorld().getServer(),summoner,this, Announcements.FAILURE,new boolean[]{summonerHasDivine,summonerHasWings,!summonerHasWings, false, true, isExalted, !isExalted});
      }
