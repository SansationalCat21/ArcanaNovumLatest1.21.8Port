...
public class ItemTagGenerator extends FabricTagProvider.ItemTagProvider {
   ...
   protected void configure(RegistryWrapper.WrapperLookup lookup){
      ...
      valueLookupBuilder(ArcanaRegistry.NEODYMIUM_STEALABLE)
            ...
            // TODO 1.21.8: .add(Items.COPPER_HELMET)
            // TODO 1.21.8: .add(Items.COPPER_CHESTPLATE)
            // TODO 1.21.8: .add(Items.COPPER_LEGGINGS)
            // TODO 1.21.8: .add(Items.COPPER_BOOTS)
            // TODO 1.21.8: .add(Items.COPPER_SWORD)
            // TODO 1.21.8: .add(Items.COPPER_AXE)
            // TODO 1.21.8: .add(Items.COPPER_SHOVEL)
            // TODO 1.21.8: .add(Items.COPPER_PICKAXE)
            // TODO 1.21.8: .add(Items.COPPER_HOE)
            // TODO 1.21.8: .add(Items.COPPER_HORSE_ARMOR)
            // TODO 1.21.8: .add(Items.COPPER_NUGGET)
            .add(Items.COPPER_BULB)
            // TODO 1.21.8: .add(Items.COPPER_BARS.unaffected())
            // TODO 1.21.8: .add(Items.COPPER_CHAINS.unaffected())
            // TODO 1.21.8: .add(Items.COPPER_GOLEM_STATUE)
            // TODO 1.21.8: .add(Items.COPPER_CHEST)
            ...
            .add(Items.SHIELD)
            .add(Items.CROSSBOW)
            // TODO 1.21.8: .add(Items.IRON_CHAIN)
            ...
            .add(Items.HOPPER)
            // TODO 1.21.8: .add(Items.IRON_SPEAR)
            // TODO 1.21.8: .add(Items.GOLDEN_SPEAR)
            // TODO 1.21.8: .add(Items.COPPER_SPEAR)
            // TODO 1.21.8: .add(Items.COPPER_NAUTILUS_ARMOR)
            // TODO 1.21.8: .add(Items.IRON_NAUTILUS_ARMOR)
            // TODO 1.21.8: .add(Items.GOLDEN_NAUTILUS_ARMOR)
      ;
