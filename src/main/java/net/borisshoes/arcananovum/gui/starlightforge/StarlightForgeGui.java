...
public class StarlightForgeGui extends VirtualInventoryGui<SimpleInventory> {
         ...
         if(index == 7){
            ...
            if(ArcanaItemUtils.isArcane(item)){
               ...
               if(canApplySkilled){
                  ...
                  ItemStack newArcanaItem = arcanaItem.addCrafter(arcanaItem.forgeItem(inventory, blockEntity),player.getUuidAsString(),0,player.getWorld().getServer());
   ...
   private void forgeItem(ArcanaItem arcanaItem, ItemStack newArcanaItem, ArcanaRecipe recipe, @Nullable Pair<ArcanaAugment, Integer> skillPair, boolean fastAnim){
      ...
      arcanaItem.buildItemLore(newArcanaItem,player.getWorld().getServer());
